...
export default function ClubPage() {
    ...
    if (showLanding) {
        return (
            <>
                <ClubLanding onGoBack={() => setShowLanding(false)} />
                <FloatingCTA onShowLanding={() => setShowLanding(false)} />
            </>
        );
    }
    ...
    return (
        <>
            ...
            {/* Floating CTA */}
            <FloatingCTA onShowLanding={() => setShowLanding(true)} />
        </>
    );
}

// Floating CTA Component
const FloatingCTA = ({ onShowLanding }: { onShowLanding: () => void }) => {
    const { resolvedTheme } = useTheme();
    const [mounted, setMounted] = useState(false);
