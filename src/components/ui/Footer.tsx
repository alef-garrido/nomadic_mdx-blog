  ...
  return (
    <footer className={`w-full transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {/* Divider */}
        <div className={`h-px mb-12 bg-gradient-to-r from-transparent via-transparent to-transparent ${
          isDark 
            ? 'via-slate-700' 
            : 'via-slate-300'
        }`}></div>
        ...
        {/* CTA Section */}
        <div className={`py-12 px-8 rounded-2xl mb-12 text-center space-y-4 transition-colors ${
          isDark
      ...
      {/* Glitch Text Section */}
      <div className={`w-full py-16 border-y transition-colors ${
        isDark
