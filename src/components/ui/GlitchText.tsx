...
const GlitchText: FC<GlitchTextProps> = ({
  ...
  const inlineStyles: CustomCSSProperties = {
    ...
    '--after-shadow': enableShadows ? '-5px 0 #FF14A1' : 'none',
    '--before-shadow': enableShadows ? '5px 0 #39FF14' : 'none'
  };

  const baseClasses = 'text-white text-[clamp(2rem,10vw,8rem)] font-black relative mx-auto select-none';
